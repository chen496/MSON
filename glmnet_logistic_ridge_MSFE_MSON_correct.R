...
write.csv(Coeff,file=paste0("final_result/code_LR/logit_MSFE_MSON_rounds_",nrounds,"_test_coefficients.csv"))

write.csv(test_pred.Prob,file=paste0("final_result/code_LR/logit_MSFE_MSON_rounds_",nrounds,"_test_prob.csv"))
write.csv(test_pred.Labels,file=paste0("final_result/code_LR/logit_MSFE_MSON_rounds_",nrounds,"_test_labels.csv"))
write.csv(SS,file=paste0("final_result/code_LR/logit_MSFE_MSON_rounds_",nrounds,"_test_TPR_TNR.csv"))
...
Pos_class<-as.numeric(logit_prob[-c(1:n_MSFE)])
Neg_class<-as.numeric(logit_prob[c(1:n_MSFE)])
...
write.csv(logit_auc,file=paste0("final_result/code_LR/logit_MSFE_MSON_rounds_",nrounds,"_test_auc.csv"))
temp<-cbind(c,c_y)
colnames(temp)<-c("x","y")
write.csv(temp,file=paste0("final_result/code_LR/logit_MSFE_MSON_rounds_",nrounds,"_test_plot_data.csv"))
