...
fit_type.measure<-"deviance"##args[1]##"auc"
...
write.csv(Coeff,file=paste0("code_LR/logit_HC_MSON_rounds_",nrounds,"_test_coefficients.csv"))
...
write.csv(Coeff,file=paste0("logit_HC_MSON_rounds_",nrounds,"_test_coefficients.csv"))
...
SS<-c(TPR,TNR)
SS
write.csv(test_pred.Prob,file=paste0("code_LR/logit_HC_MSON_rounds_",nrounds,"_test_prob.csv"))
write.csv(test_pred.Labels,file=paste0("code_LR/logit_HC_MSON_rounds_",nrounds,"_test_labels.csv"))
write.csv(SS,file=paste0("code_LR/logit_HC_MSON_rounds_",nrounds,"_test_TPR_TNR.csv"))
...
logit_auc
write.csv(logit_auc,file=paste0("code_LR/logit_HC_MSON_rounds_",nrounds,"_test_auc.csv"))
temp<-cbind(c,c_y)
colnames(temp)<-c("x","y")
write.csv(temp,file=paste0("code_LR/logit_HC_MSON_rounds_",nrounds,"_test_plot_data.csv"))
